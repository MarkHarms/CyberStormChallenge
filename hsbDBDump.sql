...
--
-- Host: localhost    Database: hsbcyberstorm
-- ------------------------------------------------------
...
/*!40000 DROP DATABASE IF EXISTS `hsbcyberstorm`*/;
...
--
-- Temporary table structure for view `challenge_info`
--
...
INSERT INTO `challenge_passwords` VALUES (1,0,'<empty>'),(1,1,'hello'),(1,2,'cbarbabuzpzrnheqjepdlti'),(1,3,'golf'),(2,0,'<empty>'),(2,1,'hello'),(2,2,'oosi'),(2,3,'golf'),(3,0,'<empty>'),(3,1,'hello'),(3,2,'ennwubqke'),(3,3,'golf');
...
INSERT INTO `teams` VALUES (1,'mark','A'),(2,'jonathan','F'),(3,'joe','F');
/*!40000 ALTER TABLE `teams` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `time_info`
--
...
/*!40000 DROP DATABASE IF EXISTS `injectiondb`*/;
...
-- Dump completed on 2019-02-20 16:40:45
